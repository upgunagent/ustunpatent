...
export default function AdminLayout({
    ...
    return (
        <div className="flex min-h-screen">
            {/* Sidebar */}
            <aside className="w-64 border-r bg-black text-white flex flex-col h-[calc(100vh)] sticky top-0">
                ...
                <nav className="flex flex-col gap-1 p-4 flex-1">
                    <Link
                        ...
                        className="flex items-center gap-2 rounded-md px-3 py-2 text-sm font-medium hover:bg-gray-900 transition-colors"
                    >
                    ...
                    <div className="mt-auto pt-4 border-t border-gray-800 pb-8">
                        <Link
                            href="/login"
